<h1><?=$this->adminMenu["cur"]->name?>: <?=$category->name?></h1>
<a href="<?php echo $this->createUrl('/'.$this->adminMenu["cur"]->code.'/adminindex')?>" class="b-link-back">Назад</a>
<? if( $this->getUserRole() == "root" ):  ?>
<a href="<?php echo $this->createUrl('/'.$this->adminMenu["cur"]->code.'/admincreate',array('category_id'=>$category->id))?>" class="ajax-form ajax-create b-butt b-top-butt">Добавить</a>
<? endif; ?>
